...
// PSourceLight – координаты источника света в мировой сферической системе координат (r,fi(град.), q(град.))
...
// Index=1 –  Зеркальная модель отражения света
{
	...
	COLORREF Col;
	double df = 0.3;                              // Шаг по азимуту, градусы
	double dq = 0.3;                              // Градусы	
	double kLight;
