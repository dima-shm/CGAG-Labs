...
void CChildView::OnPaint() 
{
	...
	if(Index==2)PIR.ColorDraw(dc, PView, WinRect, RGB(0, 0, 255));
...
{
	//CString ss="Ѕез удалени€ невидимых граней";
...
void CChildView::OnPyramidPyramid2()    // — удалением невидимых граней
{
	//CString ss="C удалением невидимых граней";
	CFrameWnd* pWnd=GetParentFrame();
	//pWnd->SetWindowTextA(ss);
